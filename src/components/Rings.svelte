<div class="flex flex-col xs:flex-row flex-wrap gap-2 justify-center mt-8">
  <a
    ...
    title="วงแหวนเว็บ"
    class="p-2 rounded-lg hover:bg-zinc-700"
  >
    <svg
      width="32"
      height="32"
  ...
  >
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      ><circle cx="103" cy="103" r="78" stroke="#8b8685" stroke-width="18" />
      <rect
        x="235"
        y="235"
        width="156"
        ...
        stroke-width="18"
      />
      <mask id="path-3-inside-1_201_11" fill="white"
        ><path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <path
        ...
        fill="#8b8685"
        mask="url(#path-3-inside-1_201_11)"
      />
      <mask id="path-5-inside-2_201_11" fill="white"
        ><path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <path
        ...
        fill="#8b8685"
        mask="url(#path-5-inside-2_201_11)"
      /></svg
    >
  </a>
</div>
